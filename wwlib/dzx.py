...
class DZx: # DZR or DZS, same format
  ...
  def remove_entity(self, entity, chunk_type, layer=None):
    ...
    # The benefit of this is that removing an entity from the list shifts down the entity indexes of all entities after it in the list, which has the potential to screw up paths to entities in world.json:LOCATIONS
    entity.name = ""
    entity.save_changes()
