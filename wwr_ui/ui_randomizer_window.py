...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_for_multiworld = QLabel(self.groupBox_3)
        self.label_for_multiworld.setObjectName(u"label_for_multiworld")
        sizePolicy1 = QSizePolicy(QSizePolicy.Minimum, QSizePolicy.Preferred)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.label_for_multiworld.sizePolicy().hasHeightForWidth())
        self.label_for_multiworld.setSizePolicy(sizePolicy1)
        self.label_for_multiworld.setMaximumSize(QSize(58, 22))

        self.horizontalLayout_14.addWidget(self.label_for_multiworld, 0, Qt.AlignLeft)

        self.multiworld = QComboBox(self.groupBox_3)
        self.multiworld.addItem("")
        self.multiworld.addItem("")
        self.multiworld.addItem("")
        self.multiworld.setObjectName(u"multiworld")
        sizePolicy2 = QSizePolicy(QSizePolicy.Minimum, QSizePolicy.Fixed)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.multiworld.sizePolicy().hasHeightForWidth())
        self.multiworld.setSizePolicy(sizePolicy2)
        self.multiworld.setMaximumSize(QSize(84, 22))

        self.horizontalLayout_14.addWidget(self.multiworld)
        ...
        QWidget.setTabOrder(self.randomize_entrances, self.multiworld)
        QWidget.setTabOrder(self.multiworld, self.randomize_music)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_for_multiworld.setText(QCoreApplication.translate("MainWindow", u"Multiworld", None))
        self.multiworld.setItemText(0, QCoreApplication.translate("MainWindow", u"Disabled", None))
        self.multiworld.setItemText(1, QCoreApplication.translate("MainWindow", u"Co-Op", None))
        self.multiworld.setItemText(2, QCoreApplication.translate("MainWindow", u"Multiworld", None))
