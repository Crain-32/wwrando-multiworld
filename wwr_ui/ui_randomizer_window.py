...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 1069, 684))
        ...
        self.gridLayout_3.addWidget(self.randomize_music, 3, 1, 1, 1)

        self.horizontalLayout_14 = QHBoxLayout()
        self.horizontalLayout_14.setObjectName(u"horizontalLayout_14")
        self.horizontalLayout_14.setContentsMargins(-1, -1, 0, -1)
        self.label_for_multiplayer = QLabel(self.groupBox_3)
        self.label_for_multiplayer.setObjectName(u"label_for_multiplayer")
        sizePolicy1 = QSizePolicy(QSizePolicy.Minimum, QSizePolicy.Preferred)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.label_for_multiplayer.sizePolicy().hasHeightForWidth())
        self.label_for_multiplayer.setSizePolicy(sizePolicy1)
        self.label_for_multiplayer.setMaximumSize(QSize(64, 22))

        self.horizontalLayout_14.addWidget(self.label_for_multiplayer, 0, Qt.AlignLeft)

        self.multiplayer = QComboBox(self.groupBox_3)
        self.multiplayer.addItem("")
        self.multiplayer.addItem("")
        self.multiplayer.addItem("")
        self.multiplayer.setObjectName(u"multiplayer")
        sizePolicy2 = QSizePolicy(QSizePolicy.Minimum, QSizePolicy.Fixed)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.multiplayer.sizePolicy().hasHeightForWidth())
        self.multiplayer.setSizePolicy(sizePolicy2)
        self.multiplayer.setMaximumSize(QSize(84, 22))

        self.horizontalLayout_14.addWidget(self.multiplayer)
        ...
        self.gridLayout_3.addLayout(self.horizontalLayout_14, 0, 3, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.randomize_enemies, 3, 0, 1, 1)
        ...
        self.widget_8.setMaximumSize(QSize(94, 22))
        self.label_for_world_count = QLabel(self.widget_8)
        self.label_for_world_count.setObjectName(u"label_for_world_count")
        self.label_for_world_count.setEnabled(True)
        self.label_for_world_count.setGeometry(QRect(0, 0, 76, 22))
        sizePolicy3.setHeightForWidth(self.label_for_world_count.sizePolicy().hasHeightForWidth())
        self.label_for_world_count.setSizePolicy(sizePolicy3)
        self.label_for_world_count.setMaximumSize(QSize(16777215, 16777215))
        self.label_for_world_count.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.world_count = QLineEdit(self.widget_8)
        self.world_count.setObjectName(u"world_count")
        self.world_count.setGeometry(QRect(72, 0, 20, 22))
        sizePolicy5 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.MinimumExpanding)
        sizePolicy5.setHorizontalStretch(0)
        sizePolicy5.setVerticalStretch(0)
        sizePolicy5.setHeightForWidth(self.world_count.sizePolicy().hasHeightForWidth())
        self.world_count.setSizePolicy(sizePolicy5)
        self.world_count.setMaximumSize(QSize(16777215, 16777215))
        ...
        self.widget_9.setMaximumSize(QSize(72, 22))
        self.label_for_world_id = QLabel(self.widget_9)
        self.label_for_world_id.setObjectName(u"label_for_world_id")
        self.label_for_world_id.setGeometry(QRect(0, 0, 47, 22))
        sizePolicy3.setHeightForWidth(self.label_for_world_id.sizePolicy().hasHeightForWidth())
        self.label_for_world_id.setSizePolicy(sizePolicy3)
        self.label_for_world_id.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.world_id = QLineEdit(self.widget_9)
        self.world_id.setObjectName(u"world_id")
        self.world_id.setGeometry(QRect(50, 0, 20, 22))
        sizePolicy6 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Maximum)
        sizePolicy6.setHorizontalStretch(0)
        sizePolicy6.setVerticalStretch(0)
        sizePolicy6.setHeightForWidth(self.world_id.sizePolicy().hasHeightForWidth())
        self.world_id.setSizePolicy(sizePolicy6)
        self.world_id.setMaximumSize(QSize(16777215, 16777215))
        ...
        self.gridLayout_3.addLayout(self.horizontalLayout_15, 2, 3, 2, 1)
        ...
        QWidget.setTabOrder(self.scrollArea, self.tabWidget)
        QWidget.setTabOrder(self.tabWidget, self.clean_iso_path)
        QWidget.setTabOrder(self.clean_iso_path, self.output_folder)
        QWidget.setTabOrder(self.output_folder, self.seed)
        QWidget.setTabOrder(self.seed, self.clean_iso_path_browse_button)
        QWidget.setTabOrder(self.clean_iso_path_browse_button, self.output_folder_browse_button)
        QWidget.setTabOrder(self.output_folder_browse_button, self.generate_seed_button)
        QWidget.setTabOrder(self.generate_seed_button, self.progression_platforms_rafts)
        QWidget.setTabOrder(self.progression_platforms_rafts, self.progression_long_sidequests)
        QWidget.setTabOrder(self.progression_long_sidequests, self.progression_dungeons)
        QWidget.setTabOrder(self.progression_dungeons, self.progression_short_sidequests)
        QWidget.setTabOrder(self.progression_short_sidequests, self.progression_treasure_charts)
        QWidget.setTabOrder(self.progression_treasure_charts, self.progression_submarines)
        QWidget.setTabOrder(self.progression_submarines, self.progression_triforce_charts)
        QWidget.setTabOrder(self.progression_triforce_charts, self.progression_spoils_trading)
        QWidget.setTabOrder(self.progression_spoils_trading, self.progression_minigames)
        QWidget.setTabOrder(self.progression_minigames, self.progression_battlesquid)
        QWidget.setTabOrder(self.progression_battlesquid, self.progression_big_octos_gunboats)
        QWidget.setTabOrder(self.progression_big_octos_gunboats, self.progression_expensive_purchases)
        QWidget.setTabOrder(self.progression_expensive_purchases, self.progression_great_fairies)
        QWidget.setTabOrder(self.progression_great_fairies, self.progression_combat_secret_caves)
        QWidget.setTabOrder(self.progression_combat_secret_caves, self.progression_free_gifts)
        QWidget.setTabOrder(self.progression_free_gifts, self.progression_savage_labyrinth)
        QWidget.setTabOrder(self.progression_savage_labyrinth, self.progression_puzzle_secret_caves)
        QWidget.setTabOrder(self.progression_puzzle_secret_caves, self.progression_misc)
        QWidget.setTabOrder(self.progression_misc, self.progression_eye_reef_chests)
        QWidget.setTabOrder(self.progression_eye_reef_chests, self.progression_mail)
        QWidget.setTabOrder(self.progression_mail, self.progression_tingle_chests)
        QWidget.setTabOrder(self.progression_tingle_chests, self.progression_island_puzzles)
        QWidget.setTabOrder(self.progression_island_puzzles, self.sword_mode)
        QWidget.setTabOrder(self.sword_mode, self.randomize_charts)
        QWidget.setTabOrder(self.randomize_charts, self.randomize_starting_island)
        QWidget.setTabOrder(self.randomize_starting_island, self.keylunacy)
        QWidget.setTabOrder(self.keylunacy, self.num_starting_triforce_shards)
        QWidget.setTabOrder(self.num_starting_triforce_shards, self.race_mode)
        QWidget.setTabOrder(self.race_mode, self.num_race_mode_dungeons)
        QWidget.setTabOrder(self.num_race_mode_dungeons, self.randomize_entrances)
        QWidget.setTabOrder(self.randomize_entrances, self.multiplayer)
        QWidget.setTabOrder(self.multiplayer, self.randomize_music)
        QWidget.setTabOrder(self.randomize_music, self.randomize_enemy_palettes)
        QWidget.setTabOrder(self.randomize_enemy_palettes, self.world_count)
        QWidget.setTabOrder(self.world_count, self.world_id)
        QWidget.setTabOrder(self.world_id, self.randomize_enemies)
        QWidget.setTabOrder(self.randomize_enemies, self.remove_title_and_ending_videos)
        QWidget.setTabOrder(self.remove_title_and_ending_videos, self.swift_sail)
        QWidget.setTabOrder(self.swift_sail, self.add_shortcut_warps_between_dungeons)
        QWidget.setTabOrder(self.add_shortcut_warps_between_dungeons, self.instant_text_boxes)
        QWidget.setTabOrder(self.instant_text_boxes, self.invert_camera_x_axis)
        QWidget.setTabOrder(self.invert_camera_x_axis, self.reveal_full_sea_chart)
        QWidget.setTabOrder(self.reveal_full_sea_chart, self.remove_music)
        QWidget.setTabOrder(self.remove_music, self.skip_rematch_bosses)
        QWidget.setTabOrder(self.skip_rematch_bosses, self.invert_sea_compass_x_axis)
        QWidget.setTabOrder(self.invert_sea_compass_x_axis, self.disable_tingle_chests_with_tingle_bombs)
        QWidget.setTabOrder(self.disable_tingle_chests_with_tingle_bombs, self.do_not_generate_spoiler_log)
        QWidget.setTabOrder(self.do_not_generate_spoiler_log, self.randomized_gear)
        ...
        QWidget.setTabOrder(self.starting_pohs, self.custom_color_preset)
        ...
        QWidget.setTabOrder(self.randomize_all_custom_colors_separately, self.custom_player_model)
        ...
        QWidget.setTabOrder(self.disable_custom_player_items, self.install_custom_model)
        QWidget.setTabOrder(self.install_custom_model, self.permalink)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.randomize_starting_island.setChecked(False)
        self.randomize_starting_island.setCheckable(False)
        ...
        self.label_for_multiplayer.setText(QCoreApplication.translate("MainWindow", u"Multiplayer", None))
        self.multiplayer.setItemText(0, QCoreApplication.translate("MainWindow", u"Disabled", None))
        self.multiplayer.setItemText(1, QCoreApplication.translate("MainWindow", u"Co-Op", None))
        self.multiplayer.setItemText(2, QCoreApplication.translate("MainWindow", u"Multiworld", None))
        ...
        self.keylunacy.setChecked(False)
        self.keylunacy.setCheckable(False)
        ...
        self.label_for_world_count.setText(QCoreApplication.translate("MainWindow", u"World Count", None))
        self.label_for_world_id.setText(QCoreApplication.translate("MainWindow", u"World ID", None))
        ...
        self.do_not_generate_spoiler_log.setChecked(False)
        self.do_not_generate_spoiler_log.setCheckable(False)
        ...
        self.update_checker_label.setText(QCoreApplication.translate("MainWindow", u"", None))
